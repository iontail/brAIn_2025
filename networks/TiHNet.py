...
class MHA(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, head_num, qkv_bias = False, attn_drop = 0, proj_drop = 0,
        ...
        kernel_size:        # Namely.
        stride_kv:          # Stride of CNN projection filter when projecting input to Key and Value
    ...
    def _build_projection(self, in_channels, out_channels, kernel_size, padding, stride, method):
        if method == 'dw_bn':
